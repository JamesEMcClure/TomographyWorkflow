...
if __name__ == '__main__':
    ...
    # Do we need to remove zingers and specks?
    ...
    f_name = 'nostripe_sorting.npy'
    np.save(f_name, np.array(nostripe))

    nostripe = tp.remove_stripe_based_fitting(proj)
    f_name = 'nostripe_fitting.npy'
    np.save(f_name, np.array(nostripe))

    nostripe = tp.remove_stripe_based_filtering(proj)
    f_name = 'nostripe_filtering.npy'
    np.save(f_name, np.array(nostripe))
